...
//         />
//         <div>
//           <p className="text-green-400">Upto:{jackpot.prize} </p>
//           <p className="text-sm text-gray-400">Draws on:{jackpot.drawsAt} </p>
//         </div>
//         <div>
//           <p className="font-bold pb-2 text-green-300">{jackpot.title} </p>
//           <p className="text-sm leading-5 text-gray-500">
//             {jackpot.description}{" "}
//           </p>
//         </div>
//         <Link
//           href={`/jackpot/${jackpot.id}`}
//           className=" border rounded-full bg-amber-500 hover:bg-amber-600 cursor-pointer font-semibold text-sm py-2 px-5"
//         >
//           PLAY NOW
//         </Link>
//       </div>
